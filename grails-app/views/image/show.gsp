...
<div id="show-image" class="content scaffold-show" role="main">
    ...
    <ol class="property-list image">
        ...
        <li class="fieldcontain">
            <span id="album-label" class="property-label">Album</span>
            <div class="property-value" aria-labelledby="album-label"><a href="${createLink(controller :'album', action :'show', id: image.album.id)}">${image.album.name}</a></div>
        </li>

        <li class="fieldcontain">
            <span id="url-label" class="property-label">Image</span>
            <div class="property-value" aria-labelledby="url-label">
                <img src="${image?.getShowImageUrl(Constants.showImageSize, Constants.showImageSize).url}">
            </div>
        </li>
    </ol>
